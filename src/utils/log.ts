...
// EAB fork: never send metrics to Language Transfer's infrastructure.
// Local console logging is kept for development. If EAB ever wants
// telemetry, it must stand up its own endpoint and revisit the consent
// copy in Settings; until then this stays false.
